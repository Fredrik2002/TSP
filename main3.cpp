...
int main(){
    ...
    my_file_approx.open("main3/datas_approx.csv");
    my_file_approx << "N, Solution Gloutonne 2, Solution 2-Approx, Solution 3/2-Approximation, Solution 2-OPT \n";
    ...
    for(int N = 8; N < 23 ;N++){
        ...
        for(int j=0;j<100;j++){
            ...
            my_file_approx<<N <<","<<g2<<","<< approx1<<","<<approx2<<","<<valeur_best_approx<<"\n";
